export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Premise",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Premise has been downloaded, would you like to install it and relaunch?",
