...
const originalWorkspaces = Flag.PREMISE_EXPERIMENTAL_WORKSPACES

function app(httpapi = true) {
  Flag.PREMISE_EXPERIMENTAL_HTTPAPI = httpapi
...
afterEach(async () => {
  ...
  Flag.PREMISE_EXPERIMENTAL_WORKSPACES = originalWorkspaces
